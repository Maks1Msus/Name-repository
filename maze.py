...
#Персонажи игры:
player = Player('hero.png', 150, win_height - 270, 4)
monster = Enemy('cyborg.png', win_width - 100, 180, 5)
final = GameSprite('treasure.png', win_width - 60, win_height - 275, 0)

w1 = Wall(239, 0, 0, 100, 20 , 450, 10)
w2 = Wall(239, 0, 0, 100, 475, 350, 10)
w3 = Wall(239, 0, 0, 100, 20 , 10, 465)
...
#музыка
mixer.init()
mixer.music.load('ohiotypebeat.ogg')
mixer.music.play()
